"""Interface molecule cell batch generation progress tracking (P2).
...
def start_batch_progress(
    ...
    Optionally sets metadata (mol_id, mol_name, etc.) for response reconstruction.

    Args:
        batch_id: The batch identifier.
        items: Optional list of item labels. If provided, updates total and items.
        metadata: Optional dict with batch-level info for response reconstruction.
    """
    with _progress_lock:
